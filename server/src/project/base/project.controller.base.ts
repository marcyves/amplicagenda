...
export class ProjectControllerBase {
  ...
  async findManyAgendas(
    ...
    const results = await this.service.findAgendas(params.id, {
      ...query,
      select: {
        completed: true,
        createdAt: true,
