...
export class ProjectResolverBase {
  ...
  async agendas(
    ...
    const results = await this.service.findAgendas(parent.id, args);
  ...
  @graphql.ResolveField(() => Rate, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Project",
    action: "read",
    possession: "any",
  ...
  async rate(
    ...
    const result = await this.service.getRate(parent.id);
